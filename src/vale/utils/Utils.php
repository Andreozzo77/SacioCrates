...
class Utils extends BaseCrate
{
	...
	public static SharedInvMenu $menu;
	public static array $row1 = [9,10,11,12,13,14,15,16,17];
	public static array $row2 = [18,19,20,21,22,23,24,25,26];
	public static array $row3 = [27,28,29,30,31,32,33,34,35];
	public static array $row4 = [36,37,38,39,40,41,42,43,45];
